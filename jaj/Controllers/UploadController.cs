...
namespace jaj.Controllers
{
    public class UploadController : Controller
    {
        ...
        public ActionResult Add(video videoModel) {
            ...
            // U ovoj varijabli je spremljen ID usera koji je loginan trenutno,pa moremo koristiti da ga spremimo u taj 
            // videouserId kad uploadamo video - moral sam pretvarati v int jer ga temp sprema ko objekt
            int iUser = (int)TempData["mydata"];
